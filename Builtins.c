/* 
 * Implementation of the built-in classes of Quack 
 *
...
/* 
 * For interal use ONLY. Function to create String object 
 * Use this to create string literals. 
 */
 ...
 * Function to construct an int object from a int literal
 */
